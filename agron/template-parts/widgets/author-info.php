<?php
class Agron_Author_Info_Widget extends WP_Widget {

    public function __construct() {
        parent::__construct(
            'author_info',
            esc_html__('About Author', 'agron'),
            ['description' => esc_html__('Display post author information', 'agron')]
        );
    }
    ...
    public function widget($args, $instance) {
        ...
        $vimeo_link = !empty($instance['vimeo']) ? $instance['vimeo'] : '';
        $pinterest_link = !empty($instance['pinterest']) ? $instance['pinterest'] : '';

        $img = pxl_get_image_by_size([
            'attach_id' => $bg_box_id,
            'thumb_size' => 'full',
        ]);
        $thumbnail_avatar = isset($img['thumbnail']) ? $img['thumbnail'] : '';
        ...
        <div class="author-box">
            <?php if (is_single()) : 
                ...
                <div class="author-info">
                    ...
                    <div class="auhthor-position">
                        <?php echo esc_html(get_the_author_meta('user_position', $author_id)); ?>
                    </div>
                </div>
                <p class="author-description">
                    <?php echo esc_html(get_the_author_meta('description')); ?>
                </p>
                <?php if (function_exists('agron_get_user_social')) agron_get_user_social($author_id); ?>
            <?php else: ?>
                <div class="author-image">
                    <?php echo wp_kses_post($thumbnail_avatar); ?>
                </div>
                <div class="author-info">
                    <div class="author-name">
                        <?php echo wp_kses_post(nl2br($name)); ?>
                    </div>
                    <div class="author-position">
                        <?php echo wp_kses_post(nl2br($position)); ?>
                    </div>
                </div>
                <?php if (!empty($description)) : ?>
                    <div class="author-description"><?php echo wp_kses_post(nl2br($description)); ?></div>
                <?php endif; ?>
                <div class="author-socials">
                    <a href="<?php echo esc_url($facebook_link); ?>" class="social-link">
                    ...
                    <a href="<?php echo esc_url($twitter_link); ?>" class="social-link">
                    ...
                    <a href="<?php echo esc_url($vimeo_link); ?>" class="social-link">        
                        <svg width="13" height="11" viewBox="0 0 13 11" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <a href="<?php echo esc_url($pinterest_link); ?>" class="social-link">
    ...
    public function form($instance) {
        ...
        ?>
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('title')); ?>"><?php _e('Title:', 'agron'); ?></label>
        ...
        <div class="author-image-wrap">
            <label for="<?php echo esc_attr($this->get_field_id('bg_box')); ?>"><?php esc_html_e('Author Image', 'agron'); ?></label>
            <input type="hidden" class="widefat hide-image-url"
                   ...
                   value="<?php echo esc_attr($instance['bg_box']); ?>"/>
            <div class="pxl-show-image">
                <?php if ($instance['bg_box']) : ?>
                    <img src="<?php echo esc_url(wp_get_attachment_image_url($instance['bg_box'])); ?>" alt="">
                <?php endif; ?>
            </div>
            <a href="#" class="pxl-select-image pxl-btn" style="<?php echo esc_attr($instance['bg_box']) ? 'display:none;' : ''; ?>"><?php esc_html_e('Select Image', 'agron'); ?></a>
            <a href="#" class="pxl-remove-image pxl-btn" style="<?php echo !$instance['bg_box'] ? 'display:none;' : ''; ?>"><?php esc_html_e('Remove Image', 'agron'); ?></a>
        </div>
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('name')); ?>"><?php esc_html_e('Name:', 'agron'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('position')); ?>"><?php esc_html_e('Position:', 'agron'); ?></label>
            <input class="widefat" id="<?php echo esc_attr($this->get_field_id('position')); ?>"
                name="<?php echo esc_attr($this->get_field_name('position')); ?>" type="text"
                value="<?php echo esc_attr($instance['position']); ?>">
        </p>
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('description')); ?>"><?php esc_html_e('Description:', 'agron'); ?></label>
    ...
    public function update($new_instance, $old_instance) {
        ...
        $instance['bg_box'] = sanitize_text_field($new_instance['bg_box']);
        $instance['name'] = sanitize_textarea_field($new_instance['name']);
        $instance['position'] = sanitize_textarea_field($new_instance['position']);
...
add_action('widgets_init', 'agron_register_author_info_widget');
function agron_register_author_info_widget(){
    if(function_exists('pxl_register_wp_widget')){
        pxl_register_wp_widget( 'Agron_Author_Info_Widget' );
    }
}
