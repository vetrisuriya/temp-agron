<?php
    ...
    if($img_dimension === 'custom') {
        ...
        $img_dimension = (!empty($custom_img_dimension['width']) && !empty($custom_img_dimension['height'])) ? $custom_img_dimension : ['width' => 767, 'height' => 1067];
    }
    ...
    $num_of_words = $widget->get_setting('num_of_words', 12);
    ...
    if($layout_type === 'grid') : 
        ...
        $wrap_attrs = [
            'class'            => 'grid pxl-project pxl-project-grid pxl-project-layout2',
...
?>
<div class="pxl-swiper pxl-project pxl-project-carousel pxl-project-layout2">
