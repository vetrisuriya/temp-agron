<?php
    ...
    if($layout_type === 'grid') : 
        ...
        $wrap_attrs = [
            'class'            => 'grid pxl-product pxl-product-grid pxl-product-layout1',
...
?>
    <div class="pxl-swiper pxl-product pxl-product-carousel pxl-product-layout1 <?php echo esc_attr($swiper_boxshadow); ?>">
