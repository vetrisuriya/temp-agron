<?php
    ...
    $show_add_to_cart = (bool)$widget->get_setting('show_add_to_cart', '');
    ...
    if($layout_type === 'grid') : 
        ...
        $wrap_attrs = [
            'class'            => 'grid pxl-product pxl-product-grid pxl-product-layout5',
...
?>
    <div class="pxl-swiper pxl-product pxl-product-carousel pxl-product-layout5 <?php echo esc_attr($swiper_boxshadow); ?>">
