<?php
    ...
    if($img_dimension === 'custom') {
        ...
        $img_dimension = (!empty($custom_img_dimension['width']) && !empty($custom_img_dimension['height'])) ? $custom_img_dimension : ['width' => 576, 'height' => 571];
    }
    ...
    if($layout_type === 'grid') : 
        ...
        $wrap_attrs = [
            'class'            => 'grid pxl-post pxl-post-grid pxl-post-layout6',
...
?>
    <div class="pxl-swiper pxl-post pxl-post-carousel pxl-post-layout6 <?php echo esc_attr($swiper_boxshadow); ?>">
