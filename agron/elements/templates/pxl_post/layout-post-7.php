<?php
    ...
    if($img_dimension === 'custom') {
        ...
        $img_dimension = (!empty($custom_img_dimension['width']) && !empty($custom_img_dimension['height'])) ? $custom_img_dimension : ['width' => 767, 'height' => 753];
    }
    ...
    if($layout_type === 'grid') : 
        ...
        $wrap_attrs = [
            'class'            => 'grid pxl-post pxl-post-grid pxl-post-layout7',
...
?>
    <div class="pxl-swiper pxl-post pxl-post-carousel pxl-post-layout7 <?php echo esc_attr($swiper_boxshadow); ?>">
