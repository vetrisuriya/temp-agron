<?php
    ...
    if($img_dimension === 'custom') {
        ...
        $img_dimension = (!empty($custom_img_dimension['width']) && !empty($custom_img_dimension['height'])) ? $custom_img_dimension : ['width' => 767, 'height' => 690];
    }
    ...
    $num_of_words = $widget->get_setting('num_of_words', 20 );
    ...
    $layout_style = 'pxl-post-'.$widget->get_setting('layout2_style', 'default');
    ...
    if($layout_type === 'grid') : 
        ...
        $wrap_attrs = [
            'class'            => 'grid pxl-post pxl-post-grid pxl-post-layout2 '.$layout_style,
...
<?php else: 
    ...
    $swiper_boxshadow = $widget->get_setting('slide_normal', '');
...
?>
    <div class="pxl-swiper pxl-post pxl-post-carousel pxl-post-layout2 <?php echo esc_attr($swiper_boxshadow.' '.$layout_style); ?>">
