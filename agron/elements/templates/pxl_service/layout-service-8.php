<?php
    ...
    if($layout_type === 'grid') : 
        ...
        $wrap_attrs = [
            'class'            => 'grid pxl-service pxl-service-grid pxl-service-layout8',
...
?>
    <div class="pxl-swiper pxl-service pxl-service-carousel pxl-service-layout8 <?php echo esc_attr($swiper_boxshadow); ?>">
