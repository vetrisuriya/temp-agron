<?php
    ...
    if($img_dimension === 'custom') {
        ...
        $img_dimension = (!empty($custom_img_dimension['width']) && !empty($custom_img_dimension['height'])) ? $custom_img_dimension : ['width' => 576, 'height' => 629];
    }
    ...
    if($layout_type === 'grid') : 
        ...
        $wrap_attrs = [
            'class'            => 'grid pxl-service pxl-service-grid pxl-service-layout4',
...
?>
    <div class="pxl-swiper pxl-service pxl-service-carousel pxl-service-layout4 <?php echo esc_attr($swiper_boxshadow); ?>">
