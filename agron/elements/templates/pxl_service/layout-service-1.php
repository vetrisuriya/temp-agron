<?php
    ...
    if($layout_type === 'grid') : 
        ...
        $wrap_attrs = [
            'class'            => 'grid pxl-service pxl-service-grid pxl-service-layout1',
...
?>
    <div class="pxl-swiper pxl-service pxl-service-carousel pxl-service-layout1 <?php echo esc_attr($swiper_boxshadow); ?>">
