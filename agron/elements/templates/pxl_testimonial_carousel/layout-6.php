<?php 
    ...
    ?>
    <div class="pxl-swiper pxl-testimonial-carousel pxl-testimonial-carousel6 <?php echo esc_attr($swiper_boxshadow); ?>">
                    ...
                    <?php foreach($items as $key => $item) : ?>
                        ...
                        <?php if($anim_delay != 0) : ?> data-wow-delay="<?php echo esc_attr(($key * $anim_delay).'ms') ?>" <?php endif; ?>>
                            <div class="pxl-testimonial-item">
                                <div class="pxl-testimonial-main">
                                    <?php if($show_rating) : ?>
                                    ...
                                    <?php endif; ?>
                                    <h5 class="pxl-testimonial-heading">
