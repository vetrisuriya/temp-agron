...
?>
    <div class="pxl-swiper pxl-post-custom post-custom-carousel post-custom-layout2">
                        ...
                        <div class="pxl-post-item">
                            ...
                            <div class="pxl-post-content">
                                <<?php echo esc_attr($title_tag); ?> class="pxl-post-title">
                                    <a <?php pxl_print_html($button_link_attr); ?> class="pxl-title-link">
                                ...
                                <a <?php pxl_print_html($button_link_attr); ?> class="button pxl-post-button pxl-button-default">
