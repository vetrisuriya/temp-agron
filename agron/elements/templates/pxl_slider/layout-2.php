<?php 
    ...
    if(!empty($slides)) : 
        ...
        // Animated 
        $button_animated = $widget->get_setting('button_first_entrance_anim', '');
        $title_animated = $widget->get_setting('title_entrance_anim', '');
    ?>
        <div class="pxl-slider slider-layout2">
                            ...
                            <div class="slide-container">
                                <div class="slide-inner">
                                    ...
                                    <div class="slide-button-wrap">
                                        <a <?php pxl_print_html($button_first_link_attr) ?> class="pxl-button pxl-button-default slide-button-first <?php echo esc_attr($button_animated); ?>">
